...
export const Card = ({ data }) => {
  return (
    <Link href={`/books/${data._id}`}>
      <a className="flex flex-col items-center max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 py-10 px-10">
