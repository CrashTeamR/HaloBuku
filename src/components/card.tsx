  ...
  return (
    <>
      <Link href={`/books/${data._id}`}>
        <div className="flex h-[30rem] max-w-xs cursor-pointer flex-col items-center justify-around rounded-lg border border-gray-200 bg-white py-10 px-10 text-gray-600 shadow-md transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl lg:h-[40rem]">
          <a className="">
            <img
              src={data.image}
              alt={data.title}
